    ...
    <div className="grid grid-cols-3 gap-4 justify-center item-center text-center text-3xl font-serif font-bold my-10 pb-10">
            <div>
                ...
                <li className="w-40 md:w-80 h-20 rounded-lg bg-white mb-6 bg-round">
                    <span className="flex justify-start text-xl ml-2 font-normal font-sans">Aglonema</span>
                    <span className="flex justify-start text-xl ml-2 font-thin font-sans mt-5 text-gray-400">261 Pencarian</span>
                </li>
                <li className="w-40 md:w-80 h-20 rounded-lg bg-white mb-6">
                    <span className="flex justify-start text-xl ml-2 font-normal font-sans"> Monster</span>
                    <span className="flex justify-start text-xl ml-2 font-thin font-sans mt-5 text-gray-400">256 Pencarian</span>
                </li>
                <li className="w-40 md:w-80 h-20 rounded-lg bg-white mb-6">
                    <span className="flex justify-start text-xl ml-2 font-normal font-sans"> Spider Plant</span>
                    <span className="flex justify-start text-xl ml-2 font-thin font-sans mt-5 text-gray-400">233 Pencarian</span>
                </li>
                <li className="w-40 md:w-80 h-20 rounded-lg bg-white mb-6">
                    <span className="flex justify-start text-xl ml-2 font-normal font-sans"> Keladi</span>
                    <span className="flex justify-start text-xl ml-2 font-thin font-sans mt-5 text-gray-400">205 Pencarian</span>
                </li>
                <li className="w-40 md:w-80 h-10 rounded-lg bg-white mb-6">
                    <span className="flex justify-start ml-2 text-xl font-normal font-sans"> Lainnya</span>
                </li>
                </ul>
            </div>
            </div>
